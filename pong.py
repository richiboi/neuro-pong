...
class Ball():
    ...
    def check_player_collide(self, player1, player2):
        ...
        if self.rect.colliderect(player1.rect):
            ...
            return_angle = (2 * self.max_return_angle * rel_y / player1.paddle_height) - self.max_return_angle
            ...
            return_angle = (2 * self.max_return_angle * rel_y / player2.paddle_height) - self.max_return_angle
...
def game_over_loop(winner):
    ...
    while run:
        ...
        pygame.draw.rect(win, (255,255,255), (rect_x, rect_y, rect_width, rect_height))
        #display the text
